...
export default function co(gen): Promise<any> {
  /* jshint validthis:true */
  var ctx = this;
  ...
  return new utils.Promise<any>(function(resolve, reject) {
...
export function toPromise(obj): Promise<any> {
  /* jshint validthis:true */
...
export function arrayToPromise(obj:Array<any>): Promise<any> {
  /* jshint validthis:true */
 ...
 * @api private
 */
function isGeneratorFunction(obj): boolean {
