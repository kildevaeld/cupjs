...
class Application extends _koa2['default'] {
    ...
    register(name, fn) {
        ...
        if (service) {
            ...
            _di.Metadata.define(_di.Metadata.instanceActivator, this._serviveActivator, fn);
    ...
    registerService(name, fn) {
        ...
        name = utils.camelize(name);
        _di.Metadata.define(_di.Metadata.instanceActivator, this._serviceActivator, fn);
        this._container.registerSingleton(name, fn);
    }
    /**
     * Use middlewares
